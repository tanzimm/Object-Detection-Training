...
def find_map(MODEL,output_num,output,GT,iou):

    MINOVERLAP = iou # default value (defined in the PASCAL VOC2012 challenge)
    model = MODEL
    ...
    GT_PATH = os.path.join(os.getcwd(), 'data',GT)
    DR_PATH = os.path.join(os.getcwd(), model ,'detection results')
    output_files_path = os.path.join(os.getcwd(), model ,output,str(output_num))
    # if there are no images then no animation can be shown
    IMG_PATH = os.path.join(os.getcwd(), 'data', 'a')
